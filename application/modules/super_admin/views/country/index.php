    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form id="Country_Form" method="post" action="<?php echo base_url(); ?>super_admin/Country/action" enctype="multipart/form-data" novalidate="novalidate">
                                <!-- Start : BOM Details -->
                                ...
                                <?php foreach ($AllCountry as $_AllCountry) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort center-text-table">
                                            <a href="<?php echo base_url() . 'super_admin/Country/index?c_id=' . $_AllCountry->id; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                                <button class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></button>
                                            </a>                                           
                                            <a href="<?php echo base_url().'super_admin/Country/delete/'.$_AllCountry->id; ?>" onclick="return confirm('Are you sure?');">
