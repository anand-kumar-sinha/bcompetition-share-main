    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form id="City_Form" method="post" action="<?php echo base_url(); ?>super_admin/City/action" enctype="multipart/form-data" novalidate="novalidate">
                                <!-- Start : BOM Details -->
                                ...
                                <?php foreach ($AllCity as $_AllCity) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort center-text-table">
                                            <a href="<?php echo base_url() . 'super_admin/City/index?ct_id=' . $_AllCity->id; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                                <button class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></button>
                                            </a>                                           
                                            <a href="<?php echo base_url().'super_admin/City/delete/'.$_AllCity->id; ?>" onclick="return confirm('Are you sure?');">
...
function GetState(country_id) {
    var  state_id = '<?php echo $state_id;?>';
     $.ajax({  
            url:"<?php echo base_url() . "super_admin/City/get_state_list"; ?>",  
            method:"POST",  
