 ...
 //echo $totalBuyHoss;exit;
                    ...
                    if($totalBuyHoss == 0){
                        if($level1Satus != "Pending"){
                            $getLeve1Status = $this->SystemModel->getLeve1Status($auth_id);
                            $getLeve1StatusInfo = $this->SystemModel->getLeve1StatusInfo($auth_id);
                            ...
                            if($getLeve1Status->auto_pool_status == 1){
                                ...
                                $total3per = ($egtmanddg_package_info->package_price * $student_group_level->level1_group_member_amount) / 100; 
                        ...
                        if($level2Satus != "Pending"){
                            $getLeve2Status = $this->SystemModel->getLeve2Status($auth_id);
                            $getLeve1StatusInfo = $this->SystemModel->getLeve1StatusInfo($auth_id);
                            if($getLeve2Status->auto_pool_status == 2){
                                ...
                                $egtmanddg_package_info = $this->SystemModel->egtmanddg_pmanage_autopool_level($package_id);
                                $total3per = ($egtmanddg_package_info->package_price * $student_group_level->level2_group_member_amount) / 100; 
                         ...
                         if($level3Satus != "Pending"){
                            $getLeve3Status = $this->SystemModel->getLeve3Status($auth_id);
                            $getLeve1StatusInfo = $this->SystemModel->getLeve1StatusInfo($auth_id);
                            if($getLeve3Status->auto_pool_status == 3){
                                ...
                                $egtmanddg_package_info = $this->SystemModel->egtmanddg_pmanage_autopool_level($package_id);
                                $total3per = ($egtmanddg_package_info->package_price * $student_group_level->level3_group_member_amount) / 100; 
                         ...
                         if($level4Satus != "Pending"){
                            $getLeve4Status = $this->SystemModel->getLeve4Status($auth_id);
                            $getLeve1StatusInfo = $this->SystemModel->getLeve1StatusInfo($auth_id);
                            if($getLeve4Status->auto_pool_status == 4){
                                 ...
                                 $egtmanddg_package_info = $this->SystemModel->egtmanddg_pmanage_autopool_level($package_id);
                                $total3per = ($egtmanddg_package_info->package_price * $student_group_level->level4_group_member_amount) / 100; 
                         ...
                         if($level5Satus != "Pending"){
                            $getLeve5Status = $this->SystemModel->getLeve5Status($auth_id);
                            $getLeve1StatusInfo = $this->SystemModel->getLeve1StatusInfo($auth_id);
                            if($getLeve5Status->auto_pool_status == 5){
                                 ...
                                 $egtmanddg_package_info = $this->SystemModel->egtmanddg_pmanage_autopool_level($package_id);
                                $total3per = ($egtmanddg_package_info->package_price * $student_group_level->level5_group_member_amount) / 100; 
    ...
    //public function studentAutoPoolLevelComplete()
    {
        ...
        if(!empty($getStudentData)){
          ...
          $getData = $this->SystemModel->getIdWiseLevelData($studentIds, $packageId);
           if(count($getData) >= $student_group_level->level2_group_member){
            // $totalRefer = $student_group_level->level2_group_member_amount;
               $egtmanddg_package_info = $this->SystemModel->egtmanddg_pmanage_autopool_level($packageId);
                $total2per = ($egtmanddg_package_info->package_price * $student_group_level->level2_group_member_amount) / 100; 
          ...
          if(count($getData) >= $student_group_level->level4_group_member){
             $egtmanddg_package_info = $this->SystemModel->egtmanddg_pmanage_autopool_level($packageId);
                $total4per = ($egtmanddg_package_info->package_price * $student_group_level->level4_group_member_amount) / 100; 
          ...
          if(count($getData) >= $student_group_level->level5_group_member){
             $egtmanddg_package_info = $this->SystemModel->egtmanddg_pmanage_autopool_level($packageId);
                $total5per = ($egtmanddg_package_info->package_price * $student_group_level->level5_group_member_amount) / 100; 
