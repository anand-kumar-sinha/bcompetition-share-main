...
<!--                                    <button class="btn btn-success btn-sm " type="button" style="background-color: #2182CF; border-color: #2182CF;" data-toggle="dropdown" aria-haspopup="true" style="margin-right: 5px;" aria-expanded="true"><i class="mdi mdi-plus"> </i> Import Questions</button>
                                    ...
                                    <div class="card col-sm-12" style="padding-left: 0; padding-right: 0; box-shadow:0px 0px 13px 0px rgba(134, 134, 134, 0.44)">
                                        ...
                                        <div id="test_details_card" class="card-body">
                                            <div style="margin-bottom: 10px">
                                                ...
                                                <input type="text" class="form-control" id="test_title" name="test_title" value="">
                                            ...
                                            <div style="margin-bottom: 10px">
                                                ...
                                                <input type="number" class="form-control" id="test_time" name="test_time" min="0" value="">
                                                <p id="test_title_err" style="color:brown; display: none;">Please enter the time</p>
                                            </div>
                                            <div style="margin-bottom: 10px">
                                                <label>Prize Pool Amount:</label>
                                                <input type="number" class="form-control" id="prize_pool_amount" name="prize_pool_amount" min="0" value=""> 
                                            </div>
                                            
                                            <div style="margin-bottom: 10px">
                                                <label>Join Amount:</label>
                                                <input type="number" class="form-control" id="join_amount" name="join_amount" min="0" value=""> 
                                            </div>
                                            <div style="margin-bottom: 10px">
                                                <label>Number of Slot:</label>
                                                <input type="number" class="form-control" id="number_of_slot" name="number_of_slot" min="" value=""> 
                                            </div>
                                            <div style="margin-bottom: 10px">
                                                <label>Point System:</label>
                                                <input type="text" class="form-control" id="point_system" name="point_system" value=""> 
                                            </div>
                                            <div style="margin-bottom: 10px">
                                                <div id="CashPrizeDiv">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <label>Rank:</label>
                                                            <input type="text" class="form-control" id="cash_prize_rank" name="cash_prize_rank[]" placeholder="1-10" value=""> 
                                                        </div>
                                                        <div class="col-md-5">
                                                             <label>Amount:</label>
                                                            <input type="number" class="form-control" id="cash_prize_amount" name="cash_prize_amount[]" min="0" value=""> 
                                                        </div>
                                                        <div class="col-md-2">
                            ...
                            <div class="box-footer">
                                ...
                                <button style="display: none;" type="submit" id="SubmitBtn" class="btn btn-primary">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input id="section_name" name="section_name" type="text" value="" class="form-control" value="ANAND SECTION">
                        </div>
                    </div>
                </div>
            </div>
...
function AddSectionQuestion() {
    ...
    var questionTemp = $("#question").val();

    var question = questionTemp.replace("<p>", "").replace("</p>", "").replace("<br>", "");
    ...
    if(ans_type == "mcqs"){
        ...
        if(typeof correct_ans === "undefined"){
            alert("Please Select Any One Option and Value");
            return false;
            var correct_ans_valtemp = "";
            var correct_ans_val = "";
        } else {
            var correct_ans_valtemp = $("#text_radio_ans_"+correct_ans).val();
            var correct_ans_val1 = correct_ans_valtemp.replace("<p>", "").replace("</p>", "");
            var correct_ans_val = correct_ans_val1.replace("<br>", "");
        }
        ...
        var chk_multi_answerCount = $('input[name="chk_multi_answer[]"]:checked').length;
    ...
    html += '<div id="question_id_'+section_id+'_'+section_question_countTemp+'" class="card col-sm-12" style="padding-left: 0; padding-right: 0; box-shadow:0px 0px 13px 0px rgba(134, 134, 134, 0.44)" id="29622">';
        ...
        html += '<input type="hidden" name="question['+section_id+'][]" id="box_question_'+section_id+'_'+section_question_countTemp+'" value="'+question.replace("<p>", "").replace("</p>", "").replace("<br>", "").replace(/"/g, "'")+'">';
        ...
        html += '<input type="hidden" name="radio_ans_a['+section_id+'][]" id="box_text_radio_ans_a_'+section_id+'_'+section_question_countTemp+'" value="'+text_radio_ans_a.replace("<p>", "").replace("</p>", "").replace("<br>", "").replace(/"/g, "'")+'">';
        html += '<input type="hidden" name="radio_ans_b['+section_id+'][]" id="box_text_radio_ans_b_'+section_id+'_'+section_question_countTemp+'" value="'+text_radio_ans_b.replace("<p>", "").replace("</p>", "").replace("<br>", "").replace(/"/g, "'")+'">';
        html += '<input type="hidden" name="radio_ans_c['+section_id+'][]" id="box_text_radio_ans_c_'+section_id+'_'+section_question_countTemp+'" value="'+text_radio_ans_c.replace("<p>", "").replace("</p>", "").replace("<br>", "").replace(/"/g, "'")+'">';
        html += '<input type="hidden" name="radio_ans_d['+section_id+'][]" id="box_text_radio_ans_d_'+section_id+'_'+section_question_countTemp+'" value="'+text_radio_ans_d.replace("<p>", "").replace("</p>", "").replace("<br>", "").replace(/"/g, "'")+'">';
        html += '<input type="hidden" name="radio_ans_e['+section_id+'][]" id="box_text_radio_ans_e_'+section_id+'_'+section_question_countTemp+'" value="'+text_radio_ans_e.replace("<p>", "").replace("</p>", "").replace("<br>", "").replace(/"/g, "'")+'">';
        html += '<input type="hidden" name="radio_ans_f['+section_id+'][]" id="box_text_radio_ans_f_'+section_id+'_'+section_question_countTemp+'" value="'+text_radio_ans_f.replace("<p>", "").replace("</p>", "").replace("<br>", "").replace(/"/g, "'")+'">';
        html += '<input type="hidden" name="chk_multi_answer_a['+section_id+'][]" id="box_chk_multi_answer_a_'+section_id+'_'+section_question_countTemp+'" value="'+chk_multi_answer_a.replace("<p>", "").replace("</p>", "").replace("<br>", "").replace(/"/g, "'")+'">';
        html += '<input type="hidden" name="chk_multi_answer_b['+section_id+'][]" id="box_chk_multi_answer_b_'+section_id+'_'+section_question_countTemp+'" value="'+chk_multi_answer_b.replace("<p>", "").replace("</p>", "").replace("<br>", "").replace(/"/g, "'")+'">';
        html += '<input type="hidden" name="chk_multi_answer_c['+section_id+'][]" id="box_chk_multi_answer_c_'+section_id+'_'+section_question_countTemp+'" value="'+chk_multi_answer_c.replace("<p>", "").replace("</p>", "").replace("<br>", "").replace(/"/g, "'")+'">';
        html += '<input type="hidden" name="chk_multi_answer_d['+section_id+'][]" id="box_chk_multi_answer_d_'+section_id+'_'+section_question_countTemp+'" value="'+chk_multi_answer_d.replace("<p>", "").replace("</p>", "").replace("<br>", "").replace(/"/g, "'")+'">';
        html += '<input type="hidden" name="chk_multi_answer_e['+section_id+'][]"id="box_chk_multi_answer_e_'+section_id+'_'+section_question_countTemp+'" value="'+chk_multi_answer_e.replace("<p>", "").replace("</p>", "").replace("<br>", "").replace(/"/g, "'")+'">';
        html += '<input type="hidden" name="chk_multi_answer_f['+section_id+'][]" id="box_chk_multi_answer_f_'+section_id+'_'+section_question_countTemp+'" value="'+chk_multi_answer_f.replace("<p>", "").replace("</p>", "").replace("<br>", "").replace(/"/g, "'")+'">';
        ...
        html += '<input type="hidden" name="radio_correct_ans['+section_id+'][]" id="box_radio_correct_ans_'+section_id+'_'+section_question_countTemp+'" value="'+correct_ans.replace("<p>", "").replace("</p>", "").replace("<br>", "").replace(/"/g, "'")+'">';
        html += '<input type="hidden" name="correct_ans_chk['+section_id+'][]" id="box_correct_ans_chk_'+section_id+'_'+section_question_countTemp+'" value="'+correct_ans_chk.replace("<p>", "").replace("</p>", "").replace("<br>", "").replace(/"/g, "'")+'">';
        html += '<input type="hidden" name="correct_ans_fill['+section_id+'][]" id="box_correct_ans_fill_'+section_id+'_'+section_question_countTemp+'" value="'+correct_ans_fill.replace("<p>", "").replace("</p>", "").replace("<br>", "").replace(/"/g, "'")+'">';
...
//    $("#section_question_count_"+section_id).val(section_question_countTemp);
   ...
   $('#box_question_'+section_id+'_'+section_question_countTemp).val(question.replace("<p>", "").replace("</p>", "").replace("<br>", ""));
    ...
    var html = '';
        html += '<div class="row" id="CashPrice'+cash_price_countNew+'" style="margin-top: 8px;">';
            html += '<div class="col-md-5">';
                html += '<input type="text" class="form-control" id="cash_prize_rank" name="cash_prize_rank[]" placeholder="1 - 10">'; 
            html += '</div>';
            html += '<div class="col-md-5">'; 
                html += '<input type="number" class="form-control" id="cash_prize_amount" name="cash_prize_amount[]" min="0">'; 
            html += '</div>';
