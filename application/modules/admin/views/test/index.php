                            ...
                            <div class="tab-pane active p-3" id="OnGoing" role="tabpanel">
                                ...
                                <div class="card col-sm-12" style="padding-left:0px; padding-right:0px; box-shadow:0px 0px 13px 0px rgba(134, 134, 134, 0.44)">
                                    ...
                                    <div class="card-body" id="33_data" data-name="Demo Test" data-auto-unpublish="yes" data-attempts="0" data-published="yes" data-publish-date="2021-10-12 08:15:49" data-unpublish-date="2021-04-13 09:19:00" data-test-type="free">
                                        ...
                                        <?php if($_AllPublishOnGoingTest->winer_list_publish != "true" && $_AllPublishOnGoingTest->result_publish != "false") { ?>
                                        <a href="<?php echo base_url();?>admin/Test/winer_list/<?php echo $_AllPublishOnGoingTest->test_id;?>_<?php echo $_AllPublishOnGoingTest->category_id;?>_<?php echo $_AllPublishOnGoingTest->id;?>">
                                        ...
                                        <?php } ?>
                                        <?php if($_AllPublishOnGoingTest->result_publish != "true" ) { ?>
                                        <a href="<?php echo base_url();?>admin/Test/view_result/<?php echo $_AllPublishOnGoingTest->test_id;?>_<?php echo $_AllPublishOnGoingTest->category_id;?>_<?php echo $_AllPublishOnGoingTest->id;?>">
                                            <button type="button" class="btn btn-info waves-effect waves-light float-right" style="margin-left: 5px;margin-right: 5px;">Result</button> &nbsp; &nbsp;
                                        </a>
                                        <?php } ?>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane p-3" id="Created" role="tabpanel">
                                ...
                                <div class="card col-sm-12" style="padding-left:0px; padding-right:0px; box-shadow:0px 0px 13px 0px rgba(134, 134, 134, 0.44)">
                                    ...
                                    <div class="card-body" id="33_data" data-name="Demo Test" data-auto-unpublish="yes" data-attempts="0" data-published="yes" data-publish-date="2021-10-12 08:15:49" data-unpublish-date="2021-04-13 09:19:00" data-test-type="free">
                                        ...
                                        <a class="btn btn-primary waves-effect waves-light float-right" href="<?php echo base_url();?>admin/Test/edit_question/<?php echo $_AllCreatedTest->id;?>">Edit</a>
                                        <!--<button type="button" onclick="editTest(<?php echo $_AllCreatedTest->id;?>,'main_test')" class="btn btn-warning waves-effect waves-light float-right"><i class="fas fa-edit"></i></button>-->
                                        ...
                                        <a href="<?php echo base_url('admin/Test/add_student?store_id='.$_AllCreatedTest->id) ?>" id="content" class="btn btn-primary waves-effect waves-light" style="font-size: 14px;line-height: 1;">Add Student</a>
                                    </div>
                                </div>
                                <?php } ?>
                            </div>
...
function editTest(test_id, test_type='') {
