...
if (isset($TestSectionDetail)) {
    $section_count = count($TestSectionDetail)+1;
} else {
...
if(isset($TestCashAllPrize)){
    $TestCashAllPrizeCount = count($TestCashAllPrize);
} else {
    $TestCashAllPrizeCount = "1";
}
...
<!--                                    <button class="btn btn-success btn-sm " type="button" style="background-color: #2182CF; border-color: #2182CF;" data-toggle="dropdown" aria-haspopup="true" style="margin-right: 5px;" aria-expanded="true"><i class="mdi mdi-plus"> </i> Import Questions</button>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <?php if (!empty($TestSectionDetail)) { ?>
                                        <?php $Unique=0; foreach ($TestSectionDetail as $row) { $Unique++; ?>
                                            <div id="">
                                                <div id="section_<?php echo $Unique; ?>" class="section_<?php echo $row->id; ?>"> 
                                                    <hr> 
                                                    <b style="font-size: 20px;" id="" value="" ><span id="section_name_span_<?php echo $Unique; ?>"><?php echo $row->section_name; ?></span></b>
                                                     <input type="hidden" id="section_question_count_<?php echo $Unique;?>" value="<?php echo count($TestSectionQuestionDetail);?>">
                                                    <input type="hidden" class="section_id" name="section_id[]" id="section_id_<?php echo $Unique; ?>" value="<?php echo $Unique; ?>">
                                                    <input type="hidden" class="section_id_auto" name="section_id_auto[]" id="section_id_auto_<?php echo $Unique; ?>" value="<?php echo $row->id; ?>">
                                                    <input type="hidden" class="section_name" name="section_name[]" id="section_name_<?php echo $Unique; ?>" value="<?php echo $row->section_name; ?>">
                                                    ...
                                                    <button onclick="deleteSectionConfirmation('<?php echo $row->id; ?>')" class="btn btn-danger waves-effect waves-light btn-sm" style="margin-right: 5px;" type="button"><i class="fa fa-trash"></i> </button>

                                                    <hr>

                                                    <?php if (!empty($TestSectionQuestionDetail)) { ?>
                                                        <div id="section_<?php echo $Unique; ?>_questions">
                                                        <?php $UniqueJ=0; foreach ($TestSectionQuestionDetail as $row_question) { $UniqueJ++;?>
                                                            <?php if ($row->id == $row_question->section_id) { ?>
                                                               
                                                                <div class="row col-sm-12">
                                                                    <div id="question_id_<?php echo $Unique.'_'.$UniqueJ; ?>" id="" class="card col-sm-12 question_div_<?php echo $row_question->id; ?>" style="padding-left: 0; padding-right: 0; box-shadow:0px 0px 13px 0px rgba(134, 134, 134, 0.44)">
                                                                        <div class="card-header" style="padding: .5rem .8rem;">
                                                                            ...
                                                                            <button class="btn btn-warning waves-effect waves-light float-right btn-sm" type="button" onclick="editQuestionModal( '<?php echo $row_question->id; ?>','<?php echo $row_question->section_id; ?>','<?php echo $row->section_name; ?>')"><i class="fas fa-edit"></i> </button>
                                                                            <button class="btn btn-danger waves-effect waves-light float-right btn-sm" style="margin-right: 5px;" type="button" onclick="deleteQuestionConfirmation('<?php echo $row_question->id; ?>')"><i class="fa fa-trash"></i> 
                                                                            </button>
                                                                        </div>
                                                                        <div class="card-body img-small" id="question_body_div_<?php echo $row_question->id; ?>">
                                                                            <span id="question_html_<?php echo $Unique.'_'.$UniqueJ; ?>">
                                                                                <p> </p>
                                                                            ...
                                                                            <?php if($row_question->question_type == "ParagraphTypeQuestion") { ?>
                                                                              <p id="html_ans_type_<?php echo $Unique.'_'.$UniqueJ; ?>">Answer Type: Paragraph type answer</p>
                                                                            <?php } else if($row_question->ans_type == "mcqs") { ?>
                                                                            <p id="html_ans_type_<?php echo $Unique.'_'.$UniqueJ; ?>">Answer Type: Single choice is correct</p>
                                                                            <p id="correct_ans_html_<?php echo $Unique.'_'.$UniqueJ; ?>">Correct Answer: <?php echo $row_question->radio_correct_ans; ?>
                                                                                (<?php
                                                                                if ($row_question->radio_correct_ans != null || $row_question->radio_correct_ans != "") {
                                                                                    $ans = "radio_ans_" . $row_question->radio_correct_ans;
                                                                                    echo $row_question->$ans;
                                                                                }
                                                                                ?>)
                                                                            </p>
                                                                            <?php } else if($row_question->ans_type == "mcqm") { ?>
                                                                            <p id="html_ans_type_<?php echo $Unique.'_'.$UniqueJ; ?>">Answer Type: MCQ (More than one is correct)</p>
                                                                            <?php 
                                                                                $correct_ans_chkArray = explode(',', $row_question->correct_ans_chk);
                                                                                foreach ($correct_ans_chkArray as $_correct_ans_chkArray){
                                                                            ?>
                                                                                <p id="correct_ans_html_<?php echo $Unique.'_'.$UniqueJ; ?>">Correct Answer: <?php echo strtoupper($_correct_ans_chkArray); ?>
                                                                                    (<?php $ans = "chk_multi_answer_" . $_correct_ans_chkArray;echo filter_var($row_question->$ans, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);?>)
                                                                                </p>
                                                                                <?php } ?> 
                                                                            <?php } else { ?>
                                                                                <p id="html_ans_type_<?php echo $Unique.'_'.$UniqueJ; ?>">Answer Type: Fill in the blank/Numerical answer</p>
                                                                                <p id="correct_ans_html_<?php echo $Unique.'_'.$UniqueJ; ?>">Correct Answer: <?php echo $row_question->correct_ans_fill; ?>
                                                                                     
                                                                                </p>
                                                                            <?php } ?>
                                                                                  <?php if($row_question->question_type != "ParagraphTypeQuestion") { ?>
                                                                            <p id="correct_mark_html_<?php echo $Unique.'_'.$UniqueJ; ?>">Correct Marking: <?php echo $row_question->marking_correct; ?>; Incorrect Marking: <?php echo $row_question->marking_incorrect; ?></p>
                                                                        <?php } ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                        ...
                                        <div id="test_details_card" class="card-body">
                                            ...
                                            <div style="margin-bottom: 10px">
                                                ...
                                                <select class="form-control" required="" id="test_type" name="test_type">
                                                    <option value="Mock Test" <?php
                                                    if ($test_type == "Mock Test") {
                                                        echo ' selected';
                                                    }
                                                    ?> >Mock Test</option>
                                                    <option value="Quiz" <?php
                                                    if ($test_type == "Quiz") {
                                                        echo ' selected';
                                                    }
                                                    ?> >Quiz</option>
                                                    <option value="Last Year" <?php
                                                            if ($test_type == "Last Year") {
                                                                echo ' selected';
                                                            }
                                                    ?> >Last Year</option>
                                            ...
                                            <div style="margin-bottom: 10px">
                                                <div id="CashPrizeDiv">
                                                    <input type="hidden" id="cash_price_count" value="<?php echo $TestCashAllPrizeCount;?>">
                                                    <?php 
                                                        $UniqueI=0;
                                                    foreach ($TestCashAllPrize as $_TestCashAllPrize) { $UniqueI++;?>
                                                    <div class="row" id="CashPrice<?php echo $UniqueI;?>" style="margin-top: 10px;">
                                                        <div class="col-md-5">
                                                             <?php if($UniqueI == 1) { ?><label>Rank:</label> <?php } ?>
                                                            <input type="text" class="form-control" id="cash_prize_rank" name="cash_prize_rank[]" placeholder="1-10" value="<?php echo $_TestCashAllPrize->cash_prize_rank;?>"> 
                                                        </div>
                                                        <div class="col-md-5">
                                                             <?php if($UniqueI == 1) { ?><label>Amount:</label> <?php } ?>
                                                            <input type="number" class="form-control" id="cash_prize_amount" name="cash_prize_amount[]" min="0"  value="<?php echo $_TestCashAllPrize->cash_prize_amount;?>"> 
                                                        </div>
                                                        <div class="col-md-2">
                                                            <?php if($UniqueI == 1) { ?>
                                                            ...
                                                            <?php } else { ?>
                                                                <span style="margin-left: -15px;margin-top: 0px;" class="btn btn-danger btn-sm" onclick="RemoveMoreCashPrice(<?php echo $UniqueI; ?>)"><i class="fa fa-minus"></i></span>
                                                            <?php } ?>
                                                        </div>
                                                    </div>
                                                    <?php } ?>
                            ...
                            <div class="box-footer">
                                <a href="<?php echo base_url();?>admin/Test"><button type="button" class="btn btn-secondary" >Cancel</button></a>
...
//            sectionCount: sectionCount
                    ...
                    function deleteSectionConfirmation( section_id) {
                    var result = confirm("Are you sure to delete section?");
                        if(result){
                              $.ajax({
                            url: "<?php echo base_url() . "admin/Test/delete_section"; ?>",
                            method: "POST",
                            data: {
                    ...
                    function deleteQuestionConfirmation( question_id) {
                    var result = confirm("Are you sure to delete question?");
                        if(result){
                              $.ajax({
                            url: "<?php echo base_url() . "admin/Test/delete_question"; ?>",
                            method: "POST",
                            data: {
                                question_id: question_id,
                            },
                            success: function (data) {
                                $('.question_div_'+question_id).slideUp();
                            }
                        });
                        }
                    }
                    
                    function editQuestionModal(question_id, section_id, section_name) {
                        $.ajax({
                            url: "<?php echo base_url() . "admin/Test/edit_question_modal"; ?>",
                            method: "POST",
                            data: {
                                section_id: section_id,
                                question_id: question_id,
...
//    $("#section_title_"+section_id).val(section_name);
                    ...
                    function AddSectionQuestion() {
                        ...
                        if (ans_type == "mcqs") {
                            ...
                            var correct_ans_chk = $.map($('input[name="chk_multi_answer"]:checked'), function (c) {
                                return c.value;
                            });
                            var searchIDs = $('input[name="chk_multi_answer"]:checked').map(function () {
                                return $(this).val();
                            }).get();
...
//    html += '</div>';
                    ...
                    function editQuestionBtn(section_id, section_question_countTemp) {
                        ...
                        var mode = "Edit";
                        var section_name = $(".section_name").map(function () {
                            return $(this).val();
                        }).get().join(', ');
...
<script>
    ...
    function AddMoreCashPrice() { 
        ...
        html += '<input type="text" class="form-control" id="point_system" name="cash_prize_rank[]" placeholder="1 - 10">';
        html += '</div>';
        html += '<div class="col-md-5">';
        html += '<input type="number" class="form-control" id="point_system" name="cash_prize_amount[]" min="0">';
        html += '</div>';
