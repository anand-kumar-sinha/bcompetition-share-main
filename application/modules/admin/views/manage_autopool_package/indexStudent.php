                                   ...
                                   if(!empty($_AllStudent->profile_pic)){
                                    ...
                                    <tr> 
                                        ...
                                        <td class="no-sort center-text-table">
                                            <a href="<?php echo base_url('admin/Manage_autopool_package/removeSub?id='.$_AllStudent->subid.'&courseid='.$store_id)?>" data-toggle="tooltip" >
                                       ...
                                       <td><img src="<?php echo base_url('uploads/student_profile/'.$studentProfile)?>" width="50px;"></td>
                                        ...
                                        <td class="no-sort center-text-table">
                                            <a href="javascript:void(0)" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add">
                                                <a href="<?php echo base_url('admin/Manage_autopool_package/addSub?id='.$_AllStudent->id.'&courseid='.$store_id)?>" data-toggle="tooltip" >
