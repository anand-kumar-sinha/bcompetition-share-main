    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form id="Category_Form" method="post" action="<?php echo base_url(); ?>admin/Category/action" enctype="multipart/form-data" novalidate="novalidate">
                                <!-- Start : BOM Details -->
                            <input type="hidden" id="id" name="id" value="<?php echo $id; ?>">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="txtFirstNameBilling">Category Name <span class="error">*</span></label>
                            ...
                            <div class="box-footer">
                                <a href="<?php echo base_url();?>admin/Category"><button type="button" class="btn btn-secondary">Cancel</button></a>
                                ...
                                <?php foreach ($AllCategory as $_AllCategory) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort center-text-table">
                                            <a href="<?php echo base_url() . 'admin/Category/index?c_id=' . $_AllCategory->id; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                                <button class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></button>
                                            </a>                                           
                                            <a href="<?php echo base_url().'admin/Category/delete/'.$_AllCategory->id; ?>" onclick="return confirm('Are you sure?');">
