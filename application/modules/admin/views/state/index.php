    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form id="State_Form" method="post" action="<?php echo base_url(); ?>admin/State/action" enctype="multipart/form-data" novalidate="novalidate">
                                <!-- Start : BOM Details -->
                            ...
                            <div class="box-footer">
                                <a href="<?php echo base_url();?>admin/State"><button type="button" class="btn btn-secondary">Cancel</button></a>
                                ...
                                <?php foreach ($AllState as $_AllState) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort center-text-table">
                                            <a href="<?php echo base_url() . 'admin/State/index?st_id=' . $_AllState->id; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                                <button class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></button>
                                            </a>                                           
                                            <a href="<?php echo base_url().'admin/State/delete/'.$_AllState->id; ?>" onclick="return confirm('Are you sure?');">
