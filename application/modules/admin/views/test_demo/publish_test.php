...
<!--                                <label class="col-sm-6" style="text-align: center; margin: auto;">Enter Price: </label>
                            ...
                            <div class="col-sm-3 row form-group" style="padding-bottom: 10px;">
                                ...
                                <input type="checkbox" name="cat_auto_unpublish[<?php echo $_AllCategory->id; ?>]" id="Unpublish_<?php echo $_AllCategory->id;?>" switch="none" class="" name="ing_list_received" value="0" onchange="autoUnpublish(`<?php echo $_AllCategory->id;?>`);">
