        ...
        <div class="modal-content">
            ...
            <form id="Category_Form" method="post" action="<?php echo base_url(); ?>admin/Test/cat_test_action" enctype="multipart/form-data" novalidate="novalidate">
                <div class="modal-body">
                    <input type="hidden" name="cat_test_id" id="cat_test_id" value="<?php echo $TestDetail->id;?>">
...
<!--                            <div class="col-sm-6 row" style="padding-bottom: 10px;">
                            ...
                            <div class="col-sm-6 row" style="padding-bottom: 10px;">
                                ...
                                <select class="form-control col-sm-7" required id="test_pay_type_" name="edit_cat_free_paid" >
                                    <option value="free" <?php if($TestDetail->free_paid== 'free') { echo "selected";}?>>Free for everyone</option>
                                    <option value="locked" <?php if($TestDetail->free_paid== 'locked') { echo "selected";}?>>Only for paid/added students</option>
                                </select>
                            </div>
                            <div class="col-sm-6 row form-group" style="padding-bottom: 10px;">
                                ...
                                <div class="input-group form-group col-sm-7 date" style="padding-left: 0; padding-right: 0;" id="publish_at_" data-target-input="nearest">
                                    <input type="text"  name="edit_cat_publish_at" class="form-control publish_at" data-target="#publish_at_" value="<?php echo date("d-m-Y", strtotime($TestDetail->publish_at)).' '.date("h:i", strtotime($TestDetail->publish_at));?>"/>
...
<!--                                <div class="input-group form-group col-sm-2" style="margin: auto; padding-left: 0; padding-right: 0;" id="publish_time_" data-target-input="nearest">
                            ...
                            <div class="col-sm-3 row form-group" style="padding-bottom: 10px;">
                                <div class="input-group form-group date" style="margin: auto; padding-right: 0; margin-left: 20px;  <?php if($TestDetail->auto_unpublish == '0') { ?>display: none;<?php } else{ ?>display: block;<?php } ?>" id="unpublish_at" data-target-input="nearest">
                                    <input type="text" name="edit_cat_unpublish_at" class="form-control auto_unpublish" data-target="#unpublish_at_" value="<?php echo date("d-m-Y", strtotime($TestDetail->unpublish_at)).' '.date("h:i", strtotime($TestDetail->unpublish_time));?>" />
                ...
                <div class="modal-footer">
					...
					<a class="btn btn-primary waves-effect waves-light" href="<?php echo base_url();?>admin/Test/edit_question/<?php echo $TestDetail->id;?>"    >Edit questions</a>
