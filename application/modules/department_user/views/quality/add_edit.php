...
if (isset($QualityDetail)) {
    ...
    $bom_detail_id = $QualityDetail->bom_detail_id;
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>department_user/quality">Quality List</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form id="departmentUser-master" method="post" action="<?php echo base_url(); ?>department_user/quality/action" enctype="multipart/form-data" novalidate="novalidate">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Bom/PartName/Code/RM Form/RM Size</label>
                                            <select name="bom_detail_id" class="custom-select select2" onchange="getJobCardNo(this.value)">
                                            <option value="">--Select--</option>
                                            <?php foreach ($AllBom as $_AllBom) { ?>
                                                <option value="<?php echo $_AllBom->bom_detail_id; ?>" <?php if ($_AllBom->bom_detail_id == $bom_detail_id) {
                                                                                                            echo 'selected';
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="job_card_number" class="custom-select" id="job_card_number">
...
<script>
    $(document).ready(function() {
        ...
        var mode = "<?= $mode ?>";
        var bom_detail_id = "<?= $bom_detail_id ?>"
        
        if (mode == 'Edit' && bom_detail_id != '') {
            var job_card_number = '<?= $job_card_number ?>'
            console.log('job_card_number', job_card_number)
            getJobCardNo(bom_detail_id, job_card_number)
        }
        $('.select2').select2();
...
//        });
    ...
    function getJobCardNo(bom_detail_id, job_card_number = '') {
        var id = $('#id').val();
        console.log('bom_detail_id-----',bom_detail_id)
        $.ajax({
            url: "<?php echo base_url() . "department_user/quality/getJobCardNo"; ?>",
            method: "POST",
            data: {
