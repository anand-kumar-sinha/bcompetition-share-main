            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url();?>admin/Client_master">Client List</a></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="box-footer">
                                ...
                                <a href="<?php echo base_url() . 'admin/Client_master/add_edit/' . $id; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="View">
