            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url();?>department_user/department_master">Department List</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                        <form id="department-form" method="post" action="<?php echo base_url();?>department_user/department_master/action" enctype="multipart/form-data" novalidate="novalidate">
