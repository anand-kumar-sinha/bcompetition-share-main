            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>department_user/BOM">BOM List</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form id="departmentUser-master" method="post" action="<?php echo base_url(); ?>department_user/BOM/action" enctype="multipart/form-data" novalidate="novalidate">
                                <!-- Start : BOM Details -->
                                    ...
                                    <?php if ($BOMPartDetail) {
                                        ...
                                        foreach ($BOMPartDetail as $_BOMPartDetail) { ?>
                                            <div class="row" id="RmFormDivMainRow<?php echo $i; ?>">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label>RM Size</label>
                                                        <input type="text" class="form-control" id="rm_size" name="rm_size[]" placeholder="T/W/L" value="<?php echo $_BOMPartDetail->rm_size; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label>RM Size</label>
                                                    <input type="text" class="form-control" id="rm_size" name="rm_size[]" value="" placeholder="T/W/L">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                            ...
                                            <?php foreach ($BOMOperationDetailNew as $_BOMOperationDetail) { ?>
                                                <tr>
                                                    ...
                                                    <td class="no-sort center-text-table">
                                                        ...
                                                        <a href="<?php echo base_url() . 'department_user/BOM/operationBOMdelete/' . $_BOMOperationDetail->id.'/'.$id; ?>" onclick="return confirm('Are you sure?');">
...
<script>
    ...
    function AddRmFormDiv() {
        ...
        html += '<div class="col-md-2">';
        html += '<div class="form-group">';
        html += '<label>RM Size</label>';
        html += '<input type="text" class="form-control" id="rm_size" name="rm_size[]" value="" placeholder="T/W/L">';
        html += '</div>';
        html += '</div>';
        html += '<div class="col-md-2">';
        html += '<div class="form-group">';
...
<script>
    ...
    function EditOperationDetail(operation_id) {
        $.ajax({
            url: "<?php echo base_url() . "department_user/BOM/edit_operation_detail"; ?>",
            method: "POST",
            data: {
    ...
    function GetCustomerPartAndCode() {
        ...
        $.ajax({
            url: "<?php echo base_url() . "department_user/BOM/get_customer_part_and_code"; ?>",
            method: "POST",
            data: {
