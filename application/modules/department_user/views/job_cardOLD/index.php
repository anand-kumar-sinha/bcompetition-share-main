                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="col-sm-6 float-sm-right right-add">
                                <a class="top-btn right-button" href="<?php echo base_url() . 'admin/job_card/add_edit/'; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add">
                                ...
                                <?php foreach ($AllJobCardList as $_AllJobCardList) { ?>
                                    <tr>
                                        ...
                                        <td class="no-sort center-text-table">
                                            <a href="<?php echo base_url() . 'admin/job_card/add_edit/' . $_AllJobCardList->id; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                                <button class="btn btn-primary btn-xs"><i class="fas fa-edit"></i></button>
                                            </a>                                           
                                            <a href="<?php echo base_url().'admin/job_card/delete/'.$_AllJobCardList->id; ?>" onclick="return confirm('Are you sure?');">
